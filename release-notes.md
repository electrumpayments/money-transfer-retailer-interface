...
<!-- README:
  ...
  * Group the descriptions under the relevant headings (but don’t include a heading if there are no changes under it):
    ...
    - Fixes -> Bugfixes that would, in the absence of any new features or breaking changes, constitute a patch version release.
...
## Version 3.0.0 - 10  June 2020

### New Feature
* add field `amount` to the `MoneyTransferRervesal` model to allow an option amount to be specified when a reversal request is made.
