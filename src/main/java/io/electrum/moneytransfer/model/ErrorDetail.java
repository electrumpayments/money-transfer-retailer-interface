...
public class ErrorDetail   {
  ...
  @NotNull
 @Size(min=0,max=40)  public String getErrorMessage() {
    return errorMessage;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(errorType, errorMessage, id, originalId, detailMessage, providerErrorCode, providerErrorMessage);
  }
  ...
  public String toString() {
    ...
    sb.append("    providerErrorCode: ").append(toIndentedString(providerErrorCode)).append("\n");
    sb.append("    providerErrorMessage: ").append(toIndentedString(providerErrorMessage)).append("\n");
    sb.append("}");
    return sb.toString();
  }
